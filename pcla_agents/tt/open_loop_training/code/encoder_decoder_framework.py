...
# PCLA tt port: local registry + build_* + no-op fp16 (no mmdet/mmdet3d/mmcls).
from .tt_compat import (TT_MODELS, BaseModule, build_backbone, build_head,
...
class EncoderDecoder(BaseModule):
    def __init__(self,  
        ...
        ## Encoder
        self.img_encoder = build_backbone(img_encoder)
