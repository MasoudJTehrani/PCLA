...
import numpy as np
# PCLA tt port: local registry/build_* (no mmdet/mmdet3d), vendored BasicBlock, pure-torch
# voxel_pooling, no-op fp16 decorators.
from open_loop_training.code.tt_compat import (
    TT_MODELS, BaseModule, build_backbone, build_neck, force_fp32, auto_fp16)
from open_loop_training.code.vendored.resnet_blocks import BasicBlock
from open_loop_training.ops.voxel_pooling import voxel_pooling
...
from open_loop_training.code.vendored.pafpn import PAFPN
