...
# PCLA tt port: local registry + mmengine BaseModule + no-op fp16 (multi_apply/reduce_mean
# and the top-level `import mmcv` were unused loss-path imports and are dropped).
from mmengine.model import BaseModule
from open_loop_training.code.tt_compat import TT_MODELS, force_fp32, auto_fp16
