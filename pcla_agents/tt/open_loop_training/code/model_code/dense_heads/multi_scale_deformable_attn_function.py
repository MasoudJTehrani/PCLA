...
from mmengine.model import xavier_init, constant_init  # moved from mmcv.cnn in modern stack
# PCLA tt port: mmengine BaseModule + no-op fp16 decorators. Deformable attention runs via
# the pure-PyTorch reference implementation below (the mmcv._ext CUDA op is unavailable in
# this environment and is not needed for inference).
from mmengine.model import BaseModule, ModuleList, Sequential
from open_loop_training.code.tt_compat import force_fp32, auto_fp16


def multi_scale_deformable_attn_pytorch(value, value_spatial_shapes,
                                        sampling_locations, attention_weights):
    """Pure-PyTorch multi-scale deformable attention (mmcv reference implementation)."""
...
# (CUDA MultiScaleDeformableAttnFunction classes removed in the PCLA tt port;
# deformable attention uses multi_scale_deformable_attn_pytorch above.)
...
class MSDeformableAttention3D(BaseModule):
    ...
    def forward(self,
        ...
        # PCLA tt port: always use the pure-PyTorch deformable attention.
