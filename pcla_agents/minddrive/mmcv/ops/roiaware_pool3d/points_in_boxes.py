...
# PCLA port: `roiaware_pool3d_ext` is a compiled extension this inference-only
# port does not build (no nvcc). Defer failure from import time to call time so
# an unused op cannot make the package unimportable.
try:
    ...
    roiaware_pool3d_ext = missing_ext("roiaware_pool3d_ext")
