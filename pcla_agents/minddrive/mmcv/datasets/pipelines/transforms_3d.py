...
# PCLA port: `view_points` was imported here but never referenced in this module.
# Dropped rather than pulling in nuscenes-devkit, which pins matplotlib/numpy and
# would risk destabilising the shared PCLA env used by the other agents.
