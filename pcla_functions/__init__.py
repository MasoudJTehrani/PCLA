...
# Cross-agent sys.modules isolation for PCLA's in-process agent loader.
from .clear_agent_modules import clear_agent_modules
...
__all__ = [
    ...
    'detect_gps_sign', 'GnssSignGuard', 'clear_agent_modules',
